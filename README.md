...
> [!TIP]
> To deploy this project using **GUI-based flow**, navigate to [console](https://console.stacktape.com/create-new-project/git-project-using-console?name=my-stacktape-app&repositoryType=public&repositoryUrl=https://github.com/stacktape/starter-ai-agent-api)
...
```bash
stacktape init --starterId ai-agent-api
```
...
- Open the **Function URL** printed to the terminal after deploy to use the agent web UI.
- Before deploying, make sure you have
  [enabled the Claude model in Amazon Bedrock](https://docs.aws.amazon.com/bedrock/latest/userguide/model-access.html)
  in your AWS region.
- Add your own tools in `src/tools.ts` to give the agent new capabilities.


## 4. Run the application in development mode
To run functions in the development mode (remotely on AWS), you can use the
[dev command](https://docs.stacktape.com/cli/commands/dev/). For example, to develop and debug lambda function `agent`, you can use

```bash
stacktape dev --region <<your-region>> --stage <<stage>> --resourceName agent
```
